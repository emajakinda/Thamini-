 ...
 * app runs inside an environment that provides it. Falls back to an in-memory
 * map otherwise so the app stays functional during local development. No
 * localStorage or sessionStorage is used anywhere.
 */
